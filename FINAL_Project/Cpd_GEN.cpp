...
Cpd_GEN::Cpd_GEN(int gen_idx, int pk) {
	...
	// 모델 포트 연결
	AddCoupling(this, (unsigned int)IN_PORT::PAUSE, State, (unsigned int)Atomic_State::IN_PORT::PAUSE);
	AddCoupling(this, (unsigned int)IN_PORT::READY, State, (unsigned int)Atomic_State::IN_PORT::READY);
